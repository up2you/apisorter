        ...
        <section className="container-max py-12">
          <div className="grid gap-8 md:grid-cols-3">
            {tiers.map((tier, index) => (
              <div
                key={tier.name}
                className={`card flex flex-col rounded-2xl p-8 transition-all duration-300 ${tier.highlight
              ...
              >
                ...
                {/* CTA Button */}
                <button
                  className={`mb-8 w-full rounded-lg py-3 font-semibold transition-all duration-200 ${tier.highlight
                      ? 'btn btn-primary'
                      : 'btn btn-secondary'
                    }`}
                >
